...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 gap-8 mb-40">
        <div className="col-span-4 text-center mb-20">
          <h1 className="text-5xl font-bold dark:text-slate-400 pt-44" id="use-cases">
            Use Cases
          </h1>
        </div>
      ...
      <div className="grid grid-cols-4 gap-8 mb-40">
        <div className="col-span-4 text-center mb-20">
          <h1 className="text-5xl font-bold dark:text-slate-400 pt-44" id="docs">
            Documentation
          </h1>
        </div>
        ...
        <div className="col-1">
          ...
          <p className="text-lg dark:text-slate-400 mt-5">
            <a
              href="https://docs.deoracle.xyz/"
              target="_blank"
              rel="noreferrer"
              className="bg-slate-200 dark:bg-white/80 text-slate-800 hover:bg-slate-200/80 dark:hover:bg-white/60 hover:text-black px-3 py-2 inline-block rounded-lg"
            >
              Read more
            </a>
          </p>
